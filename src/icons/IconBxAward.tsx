// icon:bx-award | Boxicons https://boxicons.com/ | Atisa
import * as React from "react";

function IconBxAward(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
